Vagrant.configure(2) do |config|
  config.vm.define "centos7" do |centos7|
    ...
    centos7.vm.network :forwarded_port, guest: 22, host: 2220, auto_correct: true
    centos7.vm.network :forwarded_port, guest: 80, host: 80, auto_correct: true
  ...
  config.vm.define "centos8" do |centos8|
    ...
    centos8.vm.network :forwarded_port, guest: 22, host: 2221, auto_correct: true
    centos8.vm.network :forwarded_port, guest: 80, host: 81, auto_correct: true
  ...
  config.vm.define "amzn2" do |amzn2|
    ...
    amzn2.vm.network :forwarded_port, guest: 22, host: 2222, auto_correct: true
    amzn2.vm.network :forwarded_port, guest: 80, host: 82, auto_correct: true
